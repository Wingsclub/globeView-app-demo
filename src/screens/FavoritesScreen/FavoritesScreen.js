  ...
  const renderCountryItem = ({ item }) => {
    return (
      <View style={styles.cardWrapper}>
        <TouchableOpacity onPress={() => navigation.navigate(Routes.DETAILS, { country: item })}>
        <CountryCard country={item} onPressDetails={() => navigation.navigate(Routes.DETAILS, { country: item })} />
        </TouchableOpacity>
        <TouchableOpacity
